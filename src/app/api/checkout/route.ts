...
/**
 * POST /api/checkout — turn a cart into a PENDING order and hand back the signed
 * field set the customer's browser posts to PayFast.
 *
 ...
 * see `/api/payfast/notify`. This route never marks anything paid, and the
 * customer's browser returning to `/checkout/success` is not evidence that it
 * should.
 */
